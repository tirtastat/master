...
3.  Penjelasan registrasi ulang secara *online* sesuai dengan jadwal dan diagram alur di atas adalah sebagai berikut.
    ...
    A.  Mempersiapkan dokumen yang harus diunggah (*upload*) dalam bentuk **pdf** atau **jpg** (**ukuran file tidak melebihi 250 KB**).
        ...
        9.  Surat Keterangan Kesehatan dari Rumah Sakit (*scan* dan *upload*)

        10. Surat Tes Narkoba dari Rumah Sakit untuk **semua Program Studi** (*scan* dan *upload*)
    ...
    B.  Menunggu *Username* dan *Password* untuk melakukan Registrasi ulang secara *online* yang akan dikirim ke alamat email yang digunakan saat mendaftar SBMPTN. *Username* dan *Password* akan dikirim mulai tanggal **14 -- 15 Juni 2021**.
    ...
    C.  Melakukan Registrasi ulang secara *online* dari tanggal **15 Juni - 25 Juni 2021** di [**http://admisi.untirta.ac.id**](http://admisi.untirta.ac.id){.uri target="_blank"} setelah menerima email *Username* dan *Password*. Pastikan semua data yang diisi dan berkas yang diunggah harus lengkap terlebih dahulu.
    ...
    D.  Menerima nominal UKT yang bisa dilihat di [**https://admisi.untirta.ac.id**](https://admisi.untirta.ac.id){.uri} menggunakan akun *username* dan *password* masing-masing mulai tanggal **29 Juni 2021**.
    ...
    E.  Pembayaran Uang Kuliah Tunggal (UKT) di Bank BNI seluruh Cabang Indonesia melalui *Teller* atau ATM dengan menggunakan menu *Student* *Payment* *Center* (SPC) kode untirta 8041, dengan ketentuan sebagai berikut.
        ...
        -   Waktu: **29 Juni s/d 09 Juli 2021**.
        -   Melakukan pembayaran Uang Kuliah Tunggal (UKT) dengan menyebut No Peserta SBMPTN.
    ...
    F.  Menerima Nomor Induk Mahasiswa (NIM) dan *Password* SIAKAD akan dikirim melalui email masing-masing (**30 Juni - 09 Juli 2021**).
