...
1.  Jadwal registrasi ulang\*
    ...
    +-----+--------------------------------------------------+-----------------------------+-------------------------------------------------------------------------------+
    | 3\. | **SNBT**                                         | **15 s.d. 25 Juni 2024**    | *Penetapan UKT bisa dicek di admisi/login kembali* (**26 s.d 28 Juni 2024**)  |
    |     |                                                  |                             |                                                                               |
    |     |                                                  |                             | Periode Bayar : **28 Juni s.d. 04 Juli 2024 pukul 14.00**                     |
    +-----+--------------------------------------------------+-----------------------------+-------------------------------------------------------------------------------+
    |     | *Pengiriman Akun Admisi ke email Camaba*         | **13 s.d. 15 Juni 2024**    |                                                                               |
    +-----+--------------------------------------------------+-----------------------------+-------------------------------------------------------------------------------+
    | 4\. | **SMMPTN BARAT**                                 | 12 s.d 18 Juli 2024         | 22 s.d. 26 Juli 2024                                                          |
    +-----+--------------------------------------------------+-----------------------------+-------------------------------------------------------------------------------+
    |     | Pengiriman Akun Admisi ke email Camaba           | 10 s.d 11 Juli 2024         | Penetapan UKT bisa di cek admisi (21 Juli 2024)                               |
    +-----+--------------------------------------------------+-----------------------------+-------------------------------------------------------------------------------+
    | 5\. | **SMBNU** (Seleksi Masuk Berdasarkan Nilai UTBK) | 17 s.d 21 Juli 2024         | 22 s.d 26 Juli 2024                                                           |
    +-----+--------------------------------------------------+-----------------------------+-------------------------------------------------------------------------------+
    |     | Pengiriman Akun Admisi ke email Camaba           | 16 s.d 17 Juli 2024         | Penetapan UKT bisa di cek admisi (21 Juli 2024)                               |
    +-----+--------------------------------------------------+-----------------------------+-------------------------------------------------------------------------------+
...
3.  Penjelasan registrasi ulang secara *online* sesuai dengan jadwal dan diagram alur di atas adalah sebagai berikut.
    ...
    A.  **Mempersiapkan dokumen** yang harus diunggah (*upload*) dalam bentuk **pdf** atau **jpg** (**ukuran file tidak melebihi 250 KB**).
        ...
        8.  Surat Keterangan Kesehatan dari Rumah Sakit/Klinik/Puskesmas (*scan Asli* dan *upload*)
            ...
            >
            > **Tes Narkoba akan dilaksanakan di kampus Untirta khusus bagi yang sudah selesai proses registrasi ulang (sudah membayar UKT dan mendapatkan NIM). Jadwal pelaksanaan akan diumumkan kemudian**.
    ...
    C.  **PENETAPAN UKT,** Camaba Menerima nominal UKT yang bisa dilihat di <https://admisi.untirta.ac.id> menggunakan akun *username* dan *password* masing-masing sesuai jadwal pembayaran.

    D.  **PEMBAYARAN,** Camaba melakukan Pembayaran Uang Kuliah Tunggal (UKT) di Bank BNI, BTN, dan BSI seluruh Cabang Indonesia (*Teller*, ATM, *mobile banking*, *internet banking*).

        > *Tata cara pembayaran UKT melalui BNI bisa diakses* [**di sini**](https://untirtaacid-my.sharepoint.com/:b:/g/personal/registrasi_untirta_ac_id/ESFMM3levKdGsETOvlW4Rs0BRE3TmSWXjDPGKpZ0tca9Sg?e=mqiNOY){target="_blank"}.
        >
        > *Tata cara pembayaran UKT melalui BTN bisa diakses* [**di sini**](https://untirtaacid-my.sharepoint.com/:b:/g/personal/registrasi_untirta_ac_id/ETWROEEZh_9IpxynRBZv3wcBgVCSO25fSTNKWwB5Ds91CA?e=4C1RYa){target="_blank"}.

        dengan ketentuan sebagai berikut.

        -   Melakukan pembayaran Uang Kuliah Tunggal (UKT) dengan menyebutkan No Peserta Test (SNBP, SNBT, SMMPTN).
        -   Menerima bukti pembayaran dari Bank BNI, BTN, dan BSI.
    ...
    E.  **NIM,** Mahasiswa Menerima Nomor Induk Mahasiswa (NIM) dan *Password* SIAKAD akan dikirim melalui email masing-masing setelah Pembayaran terkonfirmasi Lunas. **Segera lapor jika belum mendapat NIM setelah 2 hari tanggal pembayaran.**
