...
2.  Pemberkasan secara *online* melalui laman [**https://admisi.untirta.ac.id**](https://admisi.untirta.ac.id){.uri} sesuai dengan jadwal di atas.
    ...
    C.  Melakukan Registrasi ulang secara *online* dari tanggal **25 Maret - 06 April 2021** di <http://admisi.untirta.ac.id> setelah menerima email *Username* dan *Password*. Pastikan semua data yang diisi dan berkas yang diunggah harus lengkap.
    ...
    E.  Pembayaran Uang Kuliah Tunggal (UKT) di Bank BNI seluruh Cabang Indonesia melalui *Teller* atau ATM dengan menggunakan menu *Student* *Payment* *Center* (SPC) kode untirta 8041, dengan
        ketentuan sebagai berikut.

        1.  Waktu: **12 s/d 23 April 2021**.
        2.  Melakukan pembayaran Uang Kuliah Tunggal (UKT) dengan menyebut No Peserta SNMPTN
        3.  Menerima bukti pembayaran dari Bank BNI (Teller atau ATM)
        4.  Tata cara pembayaran UKT bisa diakses **di sini**.bit.ly/tirtaUKT
        5.  Khusus untuk Program Studi Kedokteran, UKT sebesar Rp15.000.000,00 s.d. Rp22.000.000,00 (UKT Kelompok III s.d. VIII)
