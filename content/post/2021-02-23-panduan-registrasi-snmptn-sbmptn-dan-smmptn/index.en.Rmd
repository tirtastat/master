...
3.  Penjelasan registrasi ulang secara *online* sesuai dengan jadwal dan diagram alur di atas adalah sebagai berikut.
    ...
    A.  Mempersiapkan dokumen yang harus diunggah (*upload*) dalam bentuk **pdf** atau **jpg** (**ukuran file tidak melebihi 250 KB**).
        ...
        13. Berkas dan registrasi tambahan bagi pendaftar KIP-Kuliah bisa diakses [**di sini**](/post/2021-02-01-daftar-ulang-mahasiswa-baru-peserta-kip-kuliah-jalur-snmptn-2021/){target="_blank"}.
    ...
    C.  Melakukan Registrasi ulang secara *online* dari tanggal **25 Maret - 06 April 2021** di [**http://admisi.untirta.ac.id**](http://admisi.untirta.ac.id){.uri target="_blank"} setelah menerima email *Username* dan *Password*. Pastikan semua data yang diisi dan berkas yang diunggah harus lengkap terlebih dahulu.
    ...
    D.  Menerima nominal UKT yang bisa dilihat di **https://admisi.untirta.ac.id** menggunakan akun *username* dan *password* masing-masing mulai tanggal **11 April 2021**.
