...
2.  Melakukan Pembayaran Pendaftaran
    ...
    Pembayaran pendaftaran dapat dilakukan untuk mengaktifkan Nomor Pendaftara (token) dan Password. Untuk Selanjutnya digunakan untuk **Login** ke <https://admisi.untirta.ac.id> dan melengkapi data.
...
3.  Unggah Dokumen di laman [**https://admisi.untirta.ac.id**](https://admisi.untirta.ac.id){.uri}
    ...
    c.  Unggah (*upload*) data pendukung:
        ...
        7.  Surat Pernyataan Keaslian Dokumen pendaftaran.
