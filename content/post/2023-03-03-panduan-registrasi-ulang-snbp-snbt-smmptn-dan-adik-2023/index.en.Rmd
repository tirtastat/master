...
1.  Jadwal registrasi ulang\*
    ...
    +------------+------------------------------------------+----------------------+----------------------------------------------------+
    |            | *Pengiriman Akun Admisi ke email Camaba* | *29 - 31 Maret 2023* | *11 - 13 April 2023*                               |
    |            |                                          |                      |                                                    |
    |            |                                          |                      | *Penetapan UKT bisa dicek di admisi/login kembali* |
    +------------+------------------------------------------+----------------------+----------------------------------------------------+
...
3.  Penjelasan registrasi ulang secara *online* sesuai dengan jadwal dan diagram alur di atas adalah sebagai berikut.
    ...
    A.  **Mempersiapkan dokumen** yang harus diunggah (*upload*) dalam bentuk **pdf** atau **jpg** (**ukuran file tidak melebihi 250 KB**).
        ...
        4.  Pdf Kartu Peserta Tes (Asli)

        5.  Pdf Akta Kelahiran (Asli/Dilegalisir)

        6.  Pdf Kartu Keluarga (Asli/Dilegalisir)

        7.  Bukti pembayaran listrik bagi pelanggang *pascabayar* **atau** bukti pembelian token listrik bagi pelanggan *prabayar* (Asli)
        ...
        9.  Pilih salah satu yang paling sesuai.
            ...
            b.  [**Surat Pernyataan tentang Luas Tanah dan Bangunan Rumah yang ditempati**](https://drive.google.com/file/d/1WrHzSj8ulBG2VrpmJ-ssthPfUbBl0QqL/view?usp=share_link){target="_blank"} bagi yang tidak punya SPPT (*download*, cetak, isi, *scan Asli*)
            c.  Jika Rumah Mengontrak dan tidak ada Bukti PBB lampirkan Bukti pembayaran sewa rumah bagi yang mengontrak/sewa ditambah [**Surat Pernyataan tentang Luas Tanah dan Bangunan Rumah yang ditempati**](https://drive.google.com/file/d/1WqMwvIShVGleoOzbJl6XGKKAxJDGYaRy/view?usp=share_link) (*download*, cetak, isi, *scan Asli*)
        ...
        14. Bagi siswa yang pada saat pendaftaran di Portal SNPMB mendaftarkan diri sebagai peserta KIP wajib mengisi link registrasi berikut. Berkas dan registrasi tambahan bagi pendaftar KIP-Kuliah bisa diakses [**di sini**](/post/2022-03-28-daftar-ulang-calon-mahasiswa-baru-peserta-kip-kuliah-jalur-snmptn-2022/){target="_blank"}.
